        ...
        <form method="GET" action="{{ route('catalog.index') }}">
            <div class="d-flex justify-content-between">
                <div class="flex-grow-1 pe-2">
                    ...
                    <div class="flex-grow-1 mb-3 form-floating">
                        <input type="text" class="form-control" name="description" id="inputNome"
                            value="{{ old('description', $filterByDescription) }}" placeholder="Digite a descrição do produto">
                        <label for="inputNome" class="form-label">Descrição do Produto</label>
                    </div>
                </div>
                <div class="flex-shrink-1 d-flex flex-column justify-content-between">
                    <a href="{{ route('catalog.index') }}" class="btn btn-secondary mb-3 py-3 px-4 flex-shrink-1">Limpar</a>
                    <button type="submit" class="btn btn-primary mb-3 px-4 flex-grow-1" >Filtrar</button>
                </div>
