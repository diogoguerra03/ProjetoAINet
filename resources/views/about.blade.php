...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <h2>About Us</h2>
            <p>
                Welcome to Imagine Shirt! We are a brand founded by three college students from the Polytechnic Institute of Leiria: Rafael, Diogo, and Lucas. We share a passion for fashion and entrepreneurship, which led us to create our own clothing brand.
            </p>
            </div>
